 ...
 */
JSON
JSON_Serializable::jsonValue(const JSON &propertyTree, const std::string &key) {
	auto it = propertyTree.find(key);
	if (it != propertyTree.end()) {
		return *it;
	}
 ...
 */
std::chrono::system_clock::time_point
JSON_Serializable::timeValueT(const JSON &propertyTree, const std::string &key)
{
    std::chrono::system_clock::time_point retVal;
    string strValue = stringValue(propertyTree, key);
    if (strValue.length() > 0) {
 ...
 */
void
JSON_Serializable::intVectorValue(const JSON &propertyTree, const std::string &key, std::vector<int> &retVal) {
 ...
 */
void
JSON_Serializable::setStringValue(JSON &obj, const std::string &key, const std::string &value) {
 ...
 */
void
JSON_Serializable::setLongValue(JSON &obj, const std::string &key, long value) {
